    ...
    try {
      ...
      if (userError) {
        if (userError.code === 'PGRST116') {
          // No user found
          toast.error(
            `No user found with email "${inviteEmail}". They need to create a KanbanPro account first.`,
            {
              ...
              <Dialog open={inviteDialogOpen} onOpenChange={setInviteDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Search for existing KanbanPro users by email to add them to your project.
                    </DialogDescription>
                  </DialogHeader>
                  <form onSubmit={handleInviteMember} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <div className="border rounded-md bg-amber-50 dark:bg-amber-950/10 p-3">
                          <div className="flex items-center text-amber-800 dark:text-amber-200">
                            ...
                            <div>
                              ...
                              <p className="text-xs">
                                The person needs to create a KanbanPro account first.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Only users who already have KanbanPro accounts can be added to projects.
                      </p>
                    </div>
